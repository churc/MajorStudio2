...
d3.json("allracejobtypespercorderedtot.json").then((datapercent) => {
...
////=====margin
    var margin = { top: 370, right: 0, bottom: 120, left: 200 };
...
/////=====headings and endnotes
    ...
    let subheading3 = g21.append('g') //// append text to global
        .append("text")
            .attr("class", "textsubhead")
            .text('job types ordered by seniority level, left: highest')
            .attr('x', margin.left*3)
...
let percent7 = svg21.append('g')
    percent7.selectAll('text')
            .data(datapercent)
                ...
                .text("100%")
                .attr('x', width-margin.left/1.1)
                .attr('y', (d, i) => {
                    return i * rowheight + startv + 3 ;
                })
                .attr('transform', (d, i) => {
                let a = -40;
                let x = width-margin.left/1.1
    ...
    // let percent2 = g21.append('g')
    //     .append("text")
    //         .style("visibility", "hidden")
    //         .attr("class", "percent7")
    //         .text('100%')
    //         .attr('x', width-margin.left/1.1)
    //         .attr('y', startv + rowheight)
            
    // let percent3 = g21.append('g')
    //     .append("text")
    //         .style("visibility", "hidden")
    //         .attr("class", "percent7")
    //         .text('100%')
    //         .attr('x', width-margin.left/1.1)
    //         .attr('y', startv + (rowheight*2))
            
    // let percent4 = g21.append('g')
    //     .append("text")
    //         .style("visibility", "hidden")
    //         .attr("class", "percent7")
    //         .text('100%')
    //         .attr('x', width-margin.left/1.1)
    //         .attr('y', startv + (rowheight*3))
    
    // let percent5 = g21.append('g')
    //     .append("text")
    //         .style("visibility", "hidden")
    //         .attr("class", "percent7")
    //         .text('100%')
    //         .attr('x', width-margin.left/1.1)
    //         .attr('y', startv + (rowheight*4))

    // let percent6 = g21.append('g')
    //     .append("text")
    //         .style("visibility", "hidden")
    //         .attr("class", "percent7")
    //         .text('100%')
    //         .attr('x', width-margin.left/1.1)
    //         .attr('y', startv + (rowheight*5))
    
    // let percent7 = g21.append('g')
    //     .append("text")
    //         .style("visibility", "hidden")
    //         .attr("class", "percent7")
    //         .text('100%')
    //         .attr('x', width-margin.left/1.1)
    //         .attr('y', startv + (rowheight*6))
   
//   let numbers = datanumcircles[0].total
    ...
    // let number2 = g21.append('g')
    //     .append("text")
    //         .style("visibility", "visible")
    //         .attr("class", "number7")
    //         .text('665 staff')
    //         .attr('x', width-margin.left/1.1)
    //         .attr('y', startv + 5 + rowheight)
            
    // let number3 = g21.append('g')
    //     .append("text")
    //         .style("visibility", "visible")
    //         .attr("class", "number7")
    //         .text('1165 staff')
    //         .attr('x', width-margin.left/1.1)
    //         .attr('y', startv + 5 + (rowheight*2))
            
    // let number4 = g21.append('g')
    //     .append("text")
    //         .style("visibility", "visible")
    //         .attr("class", "number7")
    //         .text('766 staff')
    //         .attr('x', width-margin.left/1.1)
    //         .attr('y', startv + 5 + (rowheight*3))
    
    // let number5 = g21.append('g')
    //     .append("text")
    //         .style("visibility", "visible")
    //         .attr("class", "number7")
    //         .text('138 staff')
    //         .attr('x', width-margin.left/1.1)
    //         .attr('y', startv + 5 + (rowheight*4))

    // let number6 = g21.append('g')
    //     .append("text")
    //         .style("visibility", "visible")
    //         .attr("class", "number7")
    //         .text('4529 staff')
    //         .attr('x', width-margin.left/1.1)
    //         .attr('y', startv + 5 + (rowheight*5))
...
////use selectAll
    ...
    // d3.selectAll(".circlepercent").attr("class", "circlepercent").style("fill", "pink")
                percent7.style("visibility", "visible")
                number7.style("visibility", "hidden")             
                
                
                
     d3.selectAll("circle").attr("class", "circlepercent").style("fill", "pink")
    //  d3.selectAll(".circlepercent").attr("class", "circlepercent").style("fill", "pink")
                    .style("opacity", "0.6")
                                .on('mouseenter', (d, i, j) => {   
                                    console.log('hover');
...
/////use selectAll
    ...
    //  d3.selectAll(".circlepercent").attr("class", "circlenumbers")
                        percent7.style("visibility", "hidden")
                        number7.style("visibility", "visible")

    d3.selectAll("circle").attr("class", "circlenumbers").style("fill", "yellow")
    //  d3.selectAll(".circlepercent").attr("class", "circlenumbers").style("fill", color1)
                    .style("opacity", "0.6")
                        .on('mouseenter', (d, i, j) => {   
                                console.log('hover');
                                console.log(d);
