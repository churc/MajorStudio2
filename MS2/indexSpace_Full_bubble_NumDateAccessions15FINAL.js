...
d3.json("after15groupsortcontinent.json").then((after15groupCount) => {
  // dataWrangling(data);
...
let heading15 = g.append('text')  //// append text to global
                .text('Brooklyn Museum Contemporary Collection artworks acquired 2015 and after, grouped by artist nationality')
                .attr('x', margin.left)
                .attr('y', margin.top*2)
                .attr('font-size', '100%') 
