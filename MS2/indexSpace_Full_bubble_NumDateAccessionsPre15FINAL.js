...
d3.json("before15groupsortcontinent.json").then((before15groupCount) => {
  // dataWrangling(data);
...
// 	console.log(margin.top)
    ...
    var svg = d3.select('#svg26')		  
        ...
        var modal = svg.append('g').attr("id", "modal2")     
...
////14 groupings
// let nationalityCount = before15groupCount.sort((a, b) => (a.continentnum > b.continentnum) ? -1 : 1);
...
let heading15 = g.append('text')  //// append text to global
                .text('Brooklyn Museum Contemporary Collection artworks acquired before 2015, grouped by artist nationality')
                .attr('x', -margin.left)
